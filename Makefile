#############################################################################
# Makefile for building: BrickBeaten
# Generated by qmake (3.0) (Qt 5.2.0)
# Project:  BrickBeaten.pro
# Template: app
# Command: C:\Qt\Qt5.2.0\5.2.0\mingw48_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile BrickBeaten.pro
#############################################################################
...
Makefile: BrickBeaten.pro C:/Qt/Qt5.2.0/5.2.0/mingw48_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.2.0/5.2.0/mingw48_32/mkspecs/features/spec_pre.prf \
		...
		BrickBeaten.pro \
		C:/Qt/Qt5.2.0/5.2.0/mingw48_32/lib/Qt5Multimedia.prl \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile BrickBeaten.pro
