...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Page_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 61, 8)
    ...
    "Page\0timeDo\0\0timeStart\0timeEnd\0reSet\0"
    "timeContinue\0saveRecord\0rankPage\0"
};
...
void Page::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->timeDo(); break;
        case 1: _t->timeStart(); break;
        case 2: _t->timeEnd(); break;
        case 3: _t->reSet(); break;
        case 4: _t->timeContinue(); break;
        case 5: _t->saveRecord(); break;
        case 6: _t->rankPage(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Page::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Page.data,
      qt_meta_data_Page,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Page.stringdata))
